...
} else if (process.env.MONGO_BACKEND_SERVICE_HOST) { 
  // If we're in Kubernetes Environment, we should have a service named "mongo-backend" in the same namespace
  service_host = process.env.MONGO_BACKEND_SERVICE_HOST
}
